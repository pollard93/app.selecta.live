...
describe('<PublishStream />', () => {
  ...
  test('should succeed', async () => {
    ...
    // Stream should not be published and displaying published view
    expect(wrapper.findWhere((n) => n.props().testID === 'Publishled')).to.have.length;
  });
  ...
  it('should fail', async () => {
    ...
    const wrapper = mount(
      <ApolloProvider client={client}>
        <PublishStream data={{ id: 'test', published: null } as any} />
      </ApolloProvider>,
    );
