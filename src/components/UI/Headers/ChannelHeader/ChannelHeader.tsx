...
import { View, ScrollView, Animated, StyleSheet, Dimensions, LayoutRectangle } from 'react-native';
...
import FollowChannel from '../../../Channel/FollowChannel/FollowChannel';
...
const ChannelHeader: FC<ChannelHeaderProps> = (props) => {
   ...
   */
  const coverImageHeadingHeight = useRef(scrollY.current.interpolate({
    inputRange: [-1000, 1000],
    outputRange: [1000 + coverImageHeadingDefaultHeight.current, -1000 + coverImageHeadingDefaultHeight.current],
    extrapolate: 'clamp',
    ...
    <View style={[GlobalStyles.PageFill, Styles.wrap]}>
      <Animated.View
        style={[
          ...
          {
            height: coverImageHeadingHeight.current,
      ...
      <Animated.View
        style={[
          Styles.headerWrap,
          { paddingTop: coverImageHeadingHeight.current },
        ]}
      >
        <View
          onLayout={(event) => {
