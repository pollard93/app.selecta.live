...
export const PUT_STREAM_MUTATION = gql`
  mutation putStream($name: String!, $info: String!, $timeFrom: DateTime!, $timeTo: DateTime!, $cost: Int!, $image: Upload, $audioOnly: Boolean, $tags: [String!]){
    putStream(name: $name, info: $info, timeFrom: $timeFrom, timeTo: $timeTo, cost: $cost, image: $image, audioOnly: $audioOnly, tags: $tags){
