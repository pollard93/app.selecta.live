...
export const UPDATE_STREAM_MUTATION = gql`
  mutation updateStream($id: String!, $name: String, $info: String, $timeFrom: DateTime, $timeTo: DateTime, $cost: Int, $image: Upload, $audioOnly: Boolean, $tags: [String!]){
    updateStream(id: $id, name: $name, info: $info, timeFrom: $timeFrom, timeTo: $timeTo, cost: $cost, image: $image, audioOnly: $audioOnly, tags: $tags){
