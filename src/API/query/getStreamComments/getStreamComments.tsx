...
import { STREAM_COMMENT_FRAGMENT } from '../../fragments/StreamMessage';
...
export const useGetStreamMessagesQuery = (options?: QueryHookOptions<getStreamComments, getStreamCommentsVariables>) => useQuery(GET_STREAM_COMMENTS_QUERY, options);
